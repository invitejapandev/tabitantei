        ...
        <div class="col-xxl-3 col-md-6 mb-5">
          <div class="card card-raised bg-dark text-white">
            <div class="card-body px-4">
              ...
              >
                <div class="me-2">
                  <div class="display-5 text-white" v-if="events">
                    {{ events.length }}
                  </div>
        ...
        <div class="col-xxl-3 col-md-6 mb-5">
          <div class="card card-raised bg-dark text-white">
            <div class="card-body px-4">
              ...
              >
                <div class="me-2">
                  <div class="display-5 text-white" v-if="allPlayers">
                    {{ allPlayers.length }}
                  </div>
        ...
        <div class="col-xxl-3 col-md-6 mb-5">
          <div class="card card-raised bg-dark text-white">
            <div class="card-body px-4">
              ...
              >
                <div class="me-2">
                  <div class="display-5 text-white" v-if="currentPlayers">
        ...
        <div class="card-header bg-dark text-white px-4">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="p-2 bd-highlight">
              ...
              >
                Export Overall Result </download-csv
              >&nbsp;
            ...
            >
              ...
              <tbody>
                <tr v-for="item in teamList" :key="item.team_number">
                  <th scope="row">Team {{ item.team_number }}</th>
                  <td>{{ item.player_count }}</td>
                  <td>
                    <span v-if="item.puzzle_progress == null"
                      >Style Secrets</span
                    >
                    ...
                    <span v-if="item.puzzle_progress == 4"
                      >Wardrobe Wisdom</span
                    >
                    <span v-if="item.puzzle_progress == 5">Karuizawa Goal</span>
                    <span v-if="item.puzzle_progress == 6"
                      >Glass Fragments</span
                    >
                    <span v-if="item.puzzle_progress == 7"
                      >Historic Horsement</span
                    >
                  ...
                  <td>
                    <progress
                      id="file"
                      v-if="item.GameProgress"
                      :value="item.GameProgress"
                      max="12"
                    ></progress>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <a
                      ...
                      href="#"
                      ><span class="badge bg-success">Help</span></a
                    >
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    ...
    getStatus() {
      if (this.info.id) {
        axios
          .post("api/game/get_current_status", {
            event_id: this.info.id,
            team_limit: this.info.team_count,
          })
          .then((response) => {
            if (response) {
    ...
    triggerWinnerResult() {
      ...
      if (this.info.id) {
        axios
          .post("api/game/get_status_piano", {
            event_id: this.info.id,
          })
          .then((response) => {
            if (response) {
        ...
        axios
          .post("api/game/get_overall_result", {
            event_id: this.info.id,
            team_count: this.info.team_count,
          })
          .then((response) => {
            if (response) {
              let tempWinnerList = [];
