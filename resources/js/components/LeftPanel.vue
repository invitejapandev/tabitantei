<template>
    <div class="miro_board">
        ...
        <!-- <transition name="fade"> -->
            <div class="newcard v-step-7"  v-if="puzzleNumber == 1" >
                            <!-- <img class="cover_image"  v-bind:src="this.imgCover"  v-if="show" /> -->
                            <svg  class="cover_image"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 772 843" preserveAspectRatio="xMinYMin meet" >
                    <image style="border-radius: 200px;"  :xlink:href="imgCover"  >
                    </image>
    ...
    <button @click="prev" :disabled="prevDisabled" class="lightbox_prev"><img  class="close_btn_img" src="../assets/prev_page.png"/>Prev</button>
  </template>

  <template v-slot:next-btn="{ next }" >
    <button class="lightbox_next" :disabled="nextDisabled" @click="next">Next<img  class="close_btn_img" src="../assets/next_page.png"/></button>
  </template>
  ...
  <template v-slot:close-btn="{ close }">
    ...
    <div class="language_buttons">
             <a  href="#" :class="[showLanguageButton ? 'appear' : '', 'float3']" @click="boardClicked(selectedImage, 1)">
            <img src="../assets/japan.png" style="width: 100%; height: 100%; 
            border-radius:70px;
                object-fit: cover;"/>
                </a>

                <a href="#" :class="[showLanguageButton ? 'appear' : '', 'float3']" @click="boardClicked(selectedImage, 0)">
